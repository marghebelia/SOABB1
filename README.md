...
* **analyses_MT_gaze.ipynb** : runs the looking time analyses during the mirror task, to compare looking time to the mirror before and after the red mark is placed on the infant forehead.
...
* **Script3_plotResults.ipynb** : preprocesses data, plots results and runs descriptive statistics based on the results file with the following format: "f0_HNR_RMS_NX.csv". 
